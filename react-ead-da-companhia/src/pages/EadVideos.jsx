...
export default function EadVideos() {
  ...
  return (
    <>
      ...
      <Main>
        <h2 class="w-full text-center text-4xl font-bold bg-gray-300 dark:text-white mb-4">
          Trilha - Fiscal
        </h2>
        {/* Card dos trilhas - Fiscal*/}
        <div className="flex flex-wrap ml-2.5">
          <div class="max-w-sm rounded overflow-hidden shadow-lg mr-2 mb-4">
            <img
              class="w-full"
              src="/img/pis-e-cofins.png"
